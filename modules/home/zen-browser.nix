  ...
  programs.zen-browser = {
    ...
    profiles = {
      ...
      UFRGS = rec {
        ...
        pins = {
          "ABNT" = {
            id = "7bffdbfa-be7c-4432-9366-bceb46d88b7f";
            container = containers.UFRGS.id;
            url = "https://www.abntcolecao.com.br/colecao.aspx";
            isEssential = true;
            position = 100;
          };

          "Moodle" = {
            id = "983e4edc-a08b-440e-ae7b-2d803a86c0ea";
            container = containers.UFRGS.id;
        ...
        settings = {
          ...
          "network.proxy.http" = "chasqueproxy.ufrgs.br";
          "network.proxy.ssl" = "chasqueproxy.ufrgs.br";
